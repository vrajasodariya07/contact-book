import { ADD_SURNAME_FAILURE, ADD_SURNAME_REQUEST, ADD_SURNAME_SUCCESS, DELETE_SURNAME_FAILURE, DELETE_SURNAME_REQUEST, DELETE_SURNAME_SUCCESS, GET_SURNAMES_FAILURE, GET_SURNAMES_REQUEST, GET_SURNAMES_SUCCESS, UPDATE_SURNAME_FAILURE, UPDATE_SURNAME_REQUEST, UPDATE_SURNAME_SUCCESS, USER_DETAILS_FAIL, USER_DETAILS_REQUEST, USER_DETAILS_RESET, USER_DETAILS_SUCCESS, USER_ENUM_FAIL, USER_ENUM_REQUEST, USER_ENUM_SUCCESS, USER_LIST_FAIL, USER_LIST_REQUEST, USER_LIST_SUCCESS, USER_LOGOUT, USER_REGISTER_FAIL, USER_REGISTER_REQUEST, USER_REGISTER_SUCCESS, USER_SEARCH_FAIL, USER_SEARCH_REQUEST, USER_SEARCH_SUCCESS, USER_SIGNIN_FAIL, USER_SIGNIN_REQUEST, USER_SIGNIN_SUCCESS, USER_UPDATE_FAIL, USER_UPDATE_PROFILE_FAIL, USER_UPDATE_PROFILE_IMAGE_FAIL, USER_UPDATE_PROFILE_IMAGE_REQUEST, USER_UPDATE_PROFILE_IMAGE_SUCCESS, USER_UPDATE_PROFILE_REQUEST, USER_UPDATE_PROFILE_RESET, USER_UPDATE_PROFILE_SUCCESS, USER_UPDATE_REQUEST, USER_UPDATE_RESET, USER_UPDATE_SUCCESS } from "../constants/userConstants";
...
const userProfileImageUpdateReducer = (state = {}, action) => {
  switch (action.type) {
    case USER_UPDATE_PROFILE_IMAGE_REQUEST:
      return { loading: true };
    case USER_UPDATE_PROFILE_IMAGE_SUCCESS:
      return { loading: false, success: true, profileImage: action.payload };
...
export { userSigninReducer, userListReducer, userRegisterReducer, userEnumReducer, userLogoutReducer, userDetailsReducer, userUpdateProfileReducer, userSearchReducer, userUpdateReducer, surnameReducer, userProfileImageUpdateReducer }